      ...
      <div class="loginSection">
        <form class="myForm text-center" action="login.php" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="email" class="myInput" id="emailID" placeholder="email-id" required name="emailid">
          </div>

          <div class="form-group">
            <!-- <i class="fas fa-lock"></i> -->
            <!-- <label class = "myLabel" for="password">Password</label> -->
            <input type="password" class="myInput" id="password" placeholder="password" required name="password">
          </div>
